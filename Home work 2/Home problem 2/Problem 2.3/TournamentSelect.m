function selectedIndividualIndex = TournamentSelect(fitnessListTraning, tournamentProbability, tournamentSize)

MOST_FIT = 1;
FITNESS = 1;
INDIVIDUAL = 2;

populationSize = length(fitnessListTraning);
tourFitnessAndIndividual = zeros(tournamentSize,2);

for i = 1:tournamentSize
    iTmp = 1 + fix(rand*populationSize);
    tourFitnessAndIndividual(i,FITNESS) = fitnessListTraning(iTmp);
